// ==========================================
// 1. IMPORTAMOS FIREBASE Y CONFIGURACIÓN
// ==========================================
...
// ==========================================
// 5. INTERACTIVIDAD (CHAT Y SCROLL SEGURA)
// ==========================================
        ...
        if(textoMensaje !== "") {
            ...
            try {
                ...
                setTimeout(() => {
                    ...
                    cuerpoChat.scrollTop = cuerpoChat.scrollHeight; // Scroll abajo
                }, 1000);
